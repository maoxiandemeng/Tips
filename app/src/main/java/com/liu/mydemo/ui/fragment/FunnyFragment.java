...
import com.liu.mydemo.ui.adapter.FunnyAdapter;
 ...
 */
public class FunnyFragment extends BaseFragment implements HotView, OnRefreshListener, OnLoadMoreListener{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mFunnyAdapter = new FunnyAdapter(getActivity(), list);
        mRecyclerView.setAdapter(mFunnyAdapter);
    ...
    public void onRefresh() {
        if (mFunnyAdapter.getItemCount() != 0) list.clear();
